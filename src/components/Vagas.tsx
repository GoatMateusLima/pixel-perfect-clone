            ...
            <div className="divide-y divide-border/20">
                {recommendedJobs.length > 0 ? (
                    recommendedJobs.map((job, i) => (
                        <motion.a // Mudamos de div para 'a' para ser clicável
                            key={i}
                            href={job.url}
                            target="_blank"
                            ...
                            className="px-4 py-3 cursor-pointer transition group block border-b border-border/10 last:border-0"
                        >
                            <div className="flex items-start justify-between gap-2 mb-1">
                                <p className="text-[12px] font-accent font-semibold text-foreground group-hover:text-primary transition leading-tight">
                                    {job.title}
                                </p>
                    ...
                    <div className="px-4 py-8 text-center text-[10px] text-muted-foreground font-accent">
