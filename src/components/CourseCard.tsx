...
// Mapeamento de cores baseado na dificuldade do curso
const getDifficultyStyle = (difficult: string) => {
  ...
  // Retorna a cor mapeada ou um padrão caso venha algo diferente do banco
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start sm:items-center gap-4 relative z-10">
        <div className="hidden sm:flex items-center justify-center w-10 h-10 rounded-full bg-background border border-border/50 group-hover:border-primary/50 group-hover:text-primary transition-colors shrink-0">
